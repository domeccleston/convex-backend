...
npm run dev
```
When prompted, select "Login or create an account" - this will enable you to connect to the Convex dashboard.

Sign into Convex with GitHub and then accept the default project setup prompts.
